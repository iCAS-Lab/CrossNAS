...
from models.modelq1 import SinglePath_Search
...
class EvolutionSearcher(object):
    ...
    def __init__(self, args):
        ...
        self.checkpoint_name = os.path.join(self.log_dir, 'checkpoint_qpim.pth.tar')
    ...
    def is_legal(self, cand):
        ...
        if cand[self.nr_layer-1] == 7 or cand[self.nr_layer-2] == 8:
            print('invalid choice!!!!!!')
            return False
        info['err'] = get_cand_err(cand, self.args)
        info['visited'] = True
    ...
    def get_mutation(self, k, mutation_num, m_prob):
        ...
        def random_func():
            ...
            for i in range(self.nr_layer):
                if i==self.nr_layer-1 and i==self.nr_layer-2:
                    if np.random.random_sample() < m_prob*5:
                        cand[i] = np.random.randint(self.nr_state)
                else:
                    if np.random.random_sample() < m_prob/2:
                        cand[i] = np.random.randint(self.nr_state)
            return tuple(cand)
...
def main():
    ...
    parser.add_argument('--population-num', type=int, default=25)
    ...
    parser.add_argument('--max-test-iters', type=int, default=100)
    parser.add_argument('--train-batch-size', type=int, default=128)
    parser.add_argument('--test-batch-size', type=int, default=200)

    parser.add_argument('--exp_name', type=str, default='spos_c10_train_supernet', help='experiment name')
    # Supernet Settings
    parser.add_argument('--layers', type=int, default=4, help='batch size')
    parser.add_argument('--num_choices', type=int, default=9, help='number choices per layer')
    # Search Settings
